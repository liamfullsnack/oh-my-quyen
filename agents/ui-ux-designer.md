...
```bash
python3 .qwen/skills/ui-ux-pro-max/scripts/search.py "<product-type>" --domain product
python3 .qwen/skills/ui-ux-pro-max/scripts/search.py "<style-keywords>" --domain style
python3 .qwen/skills/ui-ux-pro-max/scripts/search.py "<mood>" --domain typography
python3 .qwen/skills/ui-ux-pro-max/scripts/search.py "<industry>" --domain color
```
