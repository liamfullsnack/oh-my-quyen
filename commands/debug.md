...
The user invoked **/debug** with arguments (e.g. [error or issue description]): {{args}}
...
- `skills/debug/references/defense-in-depth.md`
- `skills/debug/references/frontend-verification.md`
- `skills/debug/references/investigation-methodology.md`
- `skills/debug/references/log-and-ci-analysis.md`
- `skills/debug/references/performance-diagnostics.md`
- `skills/debug/references/reporting-standards.md`
- `skills/debug/references/root-cause-tracing.md`
- `skills/debug/references/systematic-debugging.md`
- `skills/debug/references/task-management-debugging.md`
- `skills/debug/references/verification.md`
