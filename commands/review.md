...
The user invoked **/review** with arguments (e.g. [#PR | COMMIT | --pending | codebase [parallel]]): {{args}}
...
- `skills/code-review/references/adversarial-review.md`
- `skills/code-review/references/checklist-workflow.md`
- `skills/code-review/references/code-review-reception.md`
- `skills/code-review/references/codebase-scan-workflow.md`
- `skills/code-review/references/edge-case-scouting.md`
- `skills/code-review/references/input-mode-resolution.md`
- `skills/code-review/references/parallel-review-workflow.md`
- `skills/code-review/references/requesting-code-review.md`
- `skills/code-review/references/spec-compliance-review.md`
- `skills/code-review/references/task-management-reviews.md`
