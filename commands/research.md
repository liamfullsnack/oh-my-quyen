...
The user invoked **/research** with arguments (e.g. [Goal/Metric description] or inline config block): {{args}}
...
- `skills/autoresearch/references/git-memory-pattern.md`
- `skills/autoresearch/references/guard-and-noise.md`
- `skills/autoresearch/references/metric-library.md`
