...
The user invoked **/fix** with arguments (e.g. [issue] --auto|--review|--quick|--parallel): {{args}}
...
- `skills/fix/references/complexity-assessment.md`
- `skills/fix/references/diagnosis-protocol.md`
- `skills/fix/references/mode-selection.md`
- `skills/fix/references/parallel-exploration.md`
- `skills/fix/references/prevention-gate.md`
- `skills/fix/references/review-cycle.md`
- `skills/fix/references/skill-activation-matrix.md`
- `skills/fix/references/task-orchestration.md`
- `skills/fix/references/workflow-ci.md`
- `skills/fix/references/workflow-deep.md`
- `skills/fix/references/workflow-logs.md`
- `skills/fix/references/workflow-quick.md`
- `skills/fix/references/workflow-standard.md`
- `skills/fix/references/workflow-test.md`
- `skills/fix/references/workflow-types.md`
- `skills/fix/references/workflow-ui.md`
