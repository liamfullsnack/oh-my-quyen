...
The user invoked **/plan** with arguments (e.g. [task] OR [archive|red-team|validate]): {{args}}
...
6. **Red Team Review** → Run `/plan red-team {plan-path}` (hard/parallel/two modes)
7. **Post-Plan Validation** → Run `/plan validate {plan-path}` (hard/parallel/two modes)
...
After creating plan: `node .qwen/scripts/set-active-plan.cjs {plan-dir}`
...
- `skills/plan/references/archive-workflow.md`
- `skills/plan/references/codebase-understanding.md`
- `skills/plan/references/output-standards.md`
- `skills/plan/references/plan-organization.md`
- `skills/plan/references/red-team-personas.md`
- `skills/plan/references/red-team-workflow.md`
- `skills/plan/references/research-phase.md`
- `skills/plan/references/scope-challenge.md`
- `skills/plan/references/solution-design.md`
- `skills/plan/references/task-management.md`
- `skills/plan/references/validate-question-framework.md`
- `skills/plan/references/validate-workflow.md`
- `skills/plan/references/workflow-modes.md`
