---
description: "STRIDE + OWASP-based security audit with optional auto-fix. Scans code for vulnerabilities, categorizes by severity, and can iteratively fix findings using autoresearch pattern."
---

The user invoked **/security** with arguments (e.g. <scope glob or 'full'> [--fix] [--iterations N]): {{args}}
...
|------|-----------|----------|
| Audit only | `/security <scope>` | Scan → categorize → report |
...
- `skills/security/references/stride-owasp-checklist.md`
