...
The user invoked **/docs** with arguments (e.g. init|update|summarize): {{args}}
...
- `skills/docs/references/init-workflow.md`
- `skills/docs/references/summarize-workflow.md`
- `skills/docs/references/update-workflow.md`
