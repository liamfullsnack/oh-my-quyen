...
The user invoked **/test** with arguments (e.g. [context] OR ui [url]): {{args}}
...
- `skills/test/references/report-format.md`
- `skills/test/references/test-execution-workflow.md`
- `skills/test/references/ui-testing-workflow.md`
