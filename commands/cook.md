...
The user invoked **/cook** with arguments (e.g. [task|plan-path] [--interactive|--fast|--parallel|--auto|--no-test]): {{args}}
...
- `skills/cook/references/intent-detection.md`
- `skills/cook/references/review-cycle.md`
- `skills/cook/references/subagent-patterns.md`
