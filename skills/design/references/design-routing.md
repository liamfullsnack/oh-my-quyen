...
**Brand:**
```bash
node .qwen/skills/brand/scripts/inject-brand-context.cjs
node .qwen/skills/brand/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node .qwen/skills/design-system/scripts/generate-tokens.cjs -c tokens.json
node .qwen/skills/design-system/scripts/validate-tokens.cjs -d src/
```
